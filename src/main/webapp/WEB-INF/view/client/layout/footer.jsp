                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h4 class="text-light mb-3">Làm hài lòng khách hàng</h4>
                            <p class="mb-4">Sản phẩm nhập về chính hãng, hoàn tiền 100% nếu hàng kém chất lượng. <br>
                                Vui lòng khách đến, vừa lòng khách đi</p>
                            <a href="" class="btn border-secondary py-2 px-4 rounded-pill text-primary">Tìm hiểu
                                thêm</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            <h4 class="text-light mb-3">Thông tin về cửa hàng</h4>
                            <a class="btn-link" href="">Chính sách</a>
                            <a class="btn-link" href="">Điều khoản & điều kiện</a>
                            <a class="btn-link" href="">Tư vấn </a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a class="btn-link" href="">Sản phẩm hot</a>

                            <a class="btn-link" href="">Lịch sử mua hàng</a>
                            <a class="btn-link" href="">Hàng quốc tế</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i
                                    class="fas fa-copyright text-light me-2">KITSHOP</i></a>Được bảo lưu mọi
                            quyền</span>
                    </div>
