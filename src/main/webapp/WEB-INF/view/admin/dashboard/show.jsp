<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <meta name="description" content="Ndkien - Dự án laptopshop" />
            <meta name="author" content="Nguyễn Duy Kiên" />
            <title>Bảng thống kê - KITSHOP</title>
        ...
        <body class="sb-nav-fixed">
            <!-- Tái sử dụng code qua folder layout/header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="card bg-success text-white mb-4">
                                        <div class="card-body">Số lượng đặt hàng (${countOrder}) </div>
                                        <div class="card-footer d-flex align-items-center justify-content-between">
